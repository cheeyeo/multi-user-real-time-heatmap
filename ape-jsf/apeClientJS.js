 ...
 * APE JSF Setup
 */
APE.Config.baseUrl = 'http://letmein.at/experiments/ape/APE_JSF'; //APE JSF 
APE.Config.domain = 'letmein.at'; //Your domain, must be same as domain in aped.conf
APE.Config.server = 'ape.letmein.at:6969'; //APE server URL
